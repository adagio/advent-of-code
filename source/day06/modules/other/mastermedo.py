# @MasetMedo
# https://www.reddit.com/r/adventofcode/comments/a3kr4r/2018_day_6_solutions/eb7385m/

# run with python2.7
# python2.7 mastermedo.py

from collections import Counter


def mastermedo_run(filepath):

    data = [map(int, i.split(', ')) for i in open(filepath).readlines()]
